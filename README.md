...
Главная построена вокруг сценария `Начать / Продолжить`. Есть точное продолжение с сохранённого упражнения, результат дня, серия и недельная цель. Каталог свёрнут, пока доступен один комплекс.
...
Завершение показывает фактическое время в движении (без пауз и отдыха), число упражнений и недельную цель. Необязательная оценка нагрузки сохраняется в истории и в backup. Автоматического редиректа нет.
