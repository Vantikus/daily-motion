  ...
  const exercises=[
    {
      ...
      stop:'Остановитесь при резкой боли, простреле, онемении или головокружении.',
    ...
    },
    {
      ...
      stop:'Прекратите при резкой боли в спине, шее или плече, а также при онемении руки.',
    ...
    },
    {
      ...
      stop:'Остановитесь при резкой боли в паху, тазобедренном суставе, колене или пояснице.',
    ...
    },
    {
      ...
      stop:'Остановитесь при резкой боли в колене, тазобедренном суставе, пояснице или при головокружении.',
    ...
    },
    {
      ...
      stop:'Прекратите при острой боли в колене, паху, голеностопе или пояснице либо при потере равновесия.',
    ...
    },
    {
      ...
      stop:'Остановитесь при резкой боли в колене, паху, внутренней поверхности бедра или голеностопе.',
    ...
    },
    {
      ...
      stop:'Остановитесь при резкой боли в плече, запястье или груди, онемении руки или нестабильности опоры.',
    ...
    },
    {
      ...
      stop:'Остановитесь при резкой боли в запястьях, плечах или пояснице, онемении или если техника быстро разваливается.',
