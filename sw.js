const CACHE_NAME='daily-motion-v96';
const APP_SHELL=[
  '/',
  '/index.html',
  '/session.html',
  ...
  '/vendor/heroicons/hand-raised.svg',
  '/vendor/heroicons/exclamation-triangle.svg',
  '/vendor/heroicons/cloud.svg',
  ...
  '/icons/daily-motion-app-180-v96.png',
  '/icons/daily-motion-app-192-v96.png'
];
